...
<body>
    <div class="container-fluid">
        ...
        <div class="offcanvas-body">
            ...
            <li class="nav-item mb-2"><a href="/admin/dashboard"><i class="fa-solid fa-car me-2"></i>Data Kendaraan</a></li>
        ...
        <div class="row">
            ...
            <nav class="col-md-2 d-none d-md-block sidebar">
                <div class="d-flex flex-column pt-4 px-2">
                    <ul class="navbar-nav">
                    <li class="nav-item mb-2"><a href="/admin/dashboard"><i class="fa-solid fa-grip me-2"></i>Dashboard</a>
                    <!-- Menu -->
                ...
                <div class="card p-3">
                    ...
                    <div class="table-responsive">
                        ...
                        <tr>
                            ...
                            <td> 
                                <a href="edit_pengguna.php" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="hapus_pengguna.php" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody> 

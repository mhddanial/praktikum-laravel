    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="d-flex flex-column pt-4 px-2">
                ...
                <li class="nav-item mb-2"><a href="/admin/users"><i class="fa-solid fa-users me-2"></i>Data Pengguna</a></li>
            ...
            <div class="col-md-4 mb-3">
                <div class="card p-2 shadow-sm border-0 text-center">
                    <div class="card-body">
                        <h5 class="card-title text-secondary fw-bold">Total Pengguna</h5>
                        <h3 class="fw-bold text-primary">
                            <p>100</p>
                        </h3>
